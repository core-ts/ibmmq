...
var Consumer = (function () {
  ...
  Consumer.prototype.receive = function (handle) {
    return this.subscribe(handle);
  };
  Consumer.prototype.read = function (handle) {
    return this.subscribe(handle);
  };
  ...
  Consumer.prototype.subscribe = function (handle) {
    ...
    var getCBSub = function (err, hObj, gmo, md, buf) {
  ...
  Consumer.prototype.queue = function (handle) {
    ...
    var getCB = function (err, hObj, gmo, md, buf) {
      return __awaiter(_this, void 0, void 0, function () {
        var data, msg;
        return __generator(this, function (_a) {
          switch (_a.label) {
...
exports.Reader = Consumer;
exports.Receiver = Consumer;
